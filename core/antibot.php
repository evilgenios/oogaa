...
$blocked_isps = [
	...
	'Cloudflare',
	'Geekyworks It Solutions Pvt Ltd',
...
foreach ( $blocked_ips as $curip ) {

	if ( strpos( $curip, $ip ) !== false ) {
...
//foreach( $blocked_asns as $curasn ) {

// 	if ( strpos( $curasn, $ipdetails[ 'asn' ] ) ) {
...
//foreach ( $blocked_isps as $curisp ) {

//	if ( strpos( $curisp, $ipdetails[ 'isp' ] ) ) {
